<%@ page language="C#" autoeventwireup="true" inherits="custerrmsg1, App_Web_custerrmsg1.aspx.cdcab7d2" %>
...
<body>
<p>
	A problem has been detected and www.erlsindia.co.in has been shut down to prevent damage.<br><br>
	The problem seems to be caused by the following file: DOMAINS/<br><br>PAGE_FAULT_404_NOT_FOUND
</p>
<p>
	If problems continue, send us an <a href="mailto:erlsindia@erlsindia.co.in">email</a> to notify us, save any open work you may have and restart your computer, then try again later.
</p>
<p>
...
<p>
	<textarea id="server" rows="8" cols="80" style="overflow: auto; border: 0; background: #0000aa; color: #fff;" wrap="soft">Oh what the hell?! Man, you've got to be kidding me.
Look what you've done!_</textarea>
</p>
<div class="menu">
	<a href="download/home.aspx">Home</a> | <a href="mailto:erlsindia@erlsindia.co.in">Contact</a>
</div>
</body></html>